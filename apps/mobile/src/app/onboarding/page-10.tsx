...
const OPTIONS = [
  'Under 2 glasses (Barely any)',
  '2 – 3 glasses (Low)',
  '3 – 4 glasses (Moderate)',
  '4 – 5 glasses (Decent)',
  '6 – 7 glasses (Good)',
  '7 – 8 glasses (~2L target)',
  '8+ glasses (Super hydrated)',
];
...
export default function OnboardingPage10() {
  ...
  const [selected, setSelected] = useState<string | null>(answers['q6_hydration'] || answers['hydration_level'] || null);
  ...
  const handleNext = () => {
    if (selected) {
      setAnswer('hydration_level', selected);
      setAnswer('q6_hydration', selected);
      navigate('/onboarding/page-10b');
    }
  };
      ...
      <View style={styles.content}>
        <View style={styles.titleContainer}>
          <View style={styles.titleFlow}>
            ...
            <TitleText style={styles.titleOverride}>well </TitleText>
            <TitleText style={styles.titleOverride}>do </TitleText>
            <TitleText style={styles.titleOverride}>you </TitleText>
            <TitleText style={styles.titleOverride}>keep </TitleText>
            <TitleText style={styles.titleOverride}>your </TitleText>
            <TitleText style={styles.titleOverride}>skin </TitleText>
            <HighlightPhrase
              words={['deeply ', 'hydrated ']}
              secondaryColor={secondaryColor}
              textStyle={styles.titleOverride}
            />
            <TitleText style={styles.titleOverride}>each </TitleText>
            <TitleText style={styles.titleOverride}>day?</TitleText>
          </View>
        </View>
