      ...
      <main className="min-h-screen bg-white dark:bg-[#121212] px-4 sm:px-6 lg:px-8 pt-12 pb-4 transition-colors duration-200">
        ...
        <div className="space-y-10 text-[15px] leading-relaxed text-zinc-700 dark:text-zinc-300">
          ...
          <section id="support-response-times">
            <h2 className="text-xl font-semibold text-zinc-950 dark:text-white mb-3">Support Response Times SLA</h2>
            <div className="space-y-4 text-base sm:text-[17px] leading-relaxed text-zinc-800 dark:text-zinc-200">
              <p>
                Our customer support team is committed to addressing every inquiry promptly and thoroughly. Depending on the nature of your request, our expected response SLA times are as follows:
              </p>
