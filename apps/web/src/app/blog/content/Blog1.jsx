...
export default function Blog1() {
  return (
    <div className="text-zinc-700 dark:text-zinc-300 text-base sm:text-[17px] leading-[1.75] space-y-7">
      <p>
        Almost everyone who experiences stress notices breakouts in the exact same spot: the lower jawline and chin. While surface dirt or phone screens are often blamed, the reality involves hormonal sensitivity. <Link href="/blog/why-do-breakouts-keep-happening-in-the-exact-same-spot" className="font-semibold text-zinc-950 dark:text-white hover:text-[#937abd] dark:hover:text-[#937abd] transition-colors">Why do breakouts keep happening in the exact same spot?</Link> Localized sensitivity plays a major role.
      </p>

      <p>
        When chronic pressure mounts, your body releases elevated levels of cortisol. Cortisol interacts with receptors along the lower third of the face, triggering oil production and clogged pores. When paired with high-glycemic foods, this reaction accelerates even further. <Link href="/blog/how-does-high-glycemic-food-affect-sebum-production" className="font-semibold text-zinc-950 dark:text-white hover:text-[#937abd] dark:hover:text-[#937abd] transition-colors">How does high glycemic food affect sebum production?</Link> It contributes to increased oil activity.
      </p>
      ...
      <div className="p-6 sm:p-7 rounded-2xl sm:rounded-3xl bg-white dark:bg-zinc-950 border-[3px] border-zinc-950 dark:border-white shadow-md my-8">
        ...
        <p className="text-sm sm:text-base font-medium text-zinc-900 dark:text-zinc-100 leading-relaxed">
          Stress breakouts often appear <strong className="text-zinc-950 dark:text-white font-bold">48 to 72 hours</strong> after an acute trigger. Tracking this latency window helps anticipate recurring flare-ups.
        </p>
      </div>
      ...
      <div className="w-full aspect-[16/10] sm:aspect-[16/9] rounded-2xl sm:rounded-3xl overflow-hidden my-10 shadow-sm border border-zinc-200/80 dark:border-zinc-800 bg-zinc-100 dark:bg-zinc-900">
        <img
          ...
          alt="Analysis of stress impact on facial skin"
      ...
      <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-zinc-950 dark:text-white pt-4 font-[family-name:var(--font-outfit)]">
        The Stress-to-Sebum Response
      </h2>

      <p>
        The chin and jawline feature a high density of oil glands sensitive to stress signals. Key factors include:
      </p>
      ...
      <ul className="space-y-4 pl-1 my-6">
        <li className="flex items-start gap-3">
          ...
          <span>
            <strong className="text-zinc-950 dark:text-white font-bold">Oil gland stimulation:</strong> Stress signals encourage sebocytes to produce thicker oil that lodges in pores.
          </span>
        </li>
        <li className="flex items-start gap-3">
          <span className="w-[7px] h-[7px] aspect-square rounded-full bg-[#937abd] border-[1.5px] border-black dark:border-white mt-2.5 shrink-0" />
          <span>
            <strong className="text-zinc-950 dark:text-white font-bold">Follicular buildup:</strong> Trapped oil shields micro-colonies, making surface cleansing less effective on deep bumps.
          </span>
        </li>
      </ul>
      ...
      <h3 className="text-xl sm:text-2xl font-bold text-zinc-950 dark:text-white pt-4 font-[family-name:var(--font-outfit)]">
        Stress Breakout vs. Barrier Breakout
      </h3>
        ...
        <table className="w-full text-left text-sm">
          ...
          <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800">
            ...
            <tr>
              ...
              <td className="py-3 px-4">Immediate stinging after harsh products</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-zinc-950 dark:text-white pt-4 font-[family-name:var(--font-outfit)]">
        Interrupting the Breakout Loop
      </h2>

      <ol className="space-y-4 pl-1 my-6 list-decimal list-inside font-medium text-zinc-900 dark:text-zinc-200">
        <li className="leading-relaxed">
          <strong className="text-zinc-950 dark:text-white font-bold">Avoid harsh scrubbing:</strong> Aggressive scrubbing can inflame existing spots.
        </li>
        <li className="leading-relaxed">
          <strong className="text-zinc-950 dark:text-white font-bold">Use gentle hydration:</strong> Ceramides and light moisturizers maintain barrier balance.
        </li>
      </ol>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-6">
        ...
        <Link
          href="/blog/how-do-cortisol-spikes-damage-skin-collagen-over-time"
          className="p-5 sm:p-6 rounded-2xl border-[3px] border-zinc-950 dark:border-white hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors flex items-start justify-between gap-3 group"
        >
          <p className="text-base sm:text-lg font-semibold text-zinc-950 dark:text-white leading-snug">
            How Do Cortisol Spikes Damage Skin Collagen Over Time?
          </p>
          <ArrowUpRight size={22} className="text-zinc-950 dark:text-white shrink-0 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
        </Link>
      </div>
      ...
      <div className="mt-14 sm:mt-20 text-center flex flex-col items-center justify-center gap-6">
        <div className="max-w-2xl mx-auto space-y-3">
          ...
          <p className="text-zinc-600 dark:text-zinc-300 text-base sm:text-lg leading-relaxed font-normal max-w-xl mx-auto">
            Skin Story lets you log daily habits and track skin patterns with simple tools.
          </p>
        </div>
