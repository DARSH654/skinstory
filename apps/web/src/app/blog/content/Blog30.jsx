...
export default function Blog30() {
  return (
    <div className="text-zinc-700 dark:text-zinc-300 text-base sm:text-[17px] leading-[1.75] space-y-7">
      <p>
        Premenstrual skin flare-ups occur during the late luteal phase (days 21–28 of the menstrual cycle) when estrogen levels drop sharply while progesterone remains elevated relative to estrogen. Progesterone stimulates sebaceous gland proliferation and causes mild facial tissue swelling that physically constricts pore openings, trapping oil right as circulating testosterone reaches its relative monthly peak. <Link href="/blog/why-do-hormonal-breakouts-follow-a-predictable-28-day-pattern" className="font-semibold text-zinc-950 dark:text-white hover:text-[#937abd] dark:hover:text-[#937abd] transition-colors">Why do hormonal breakouts follow a predictable 28-day pattern?</Link> Cycle tracking reveals exact breakout windows.
      </p>
      ...
      <div className="p-6 sm:p-7 rounded-2xl sm:rounded-3xl bg-white dark:bg-zinc-950 border-[3px] border-zinc-950 dark:border-white shadow-md my-8">
        ...
        <p className="text-sm sm:text-base font-medium text-zinc-900 dark:text-zinc-100 leading-relaxed">
          Progesterone peak combined with estrogen withdrawal causes pore aperture constriction and elevated sebum lipid viscosity, triggering deep inflamed jawline papules during the late luteal phase.
        </p>
      </div>
      ...
      <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-zinc-950 dark:text-white pt-4 font-[family-name:var(--font-outfit)]">
        The Biological Stages of the Luteal Skin Flare
      </h2>
      ...
      <ul className="space-y-4 pl-1 my-6">
        <li className="flex items-start gap-3">
          ...
          <span>
            <strong className="text-zinc-950 dark:text-white font-bold">Pore Aperture Constriction:</strong> Fluid retention induced by luteal progesterone narrows follicular exits, preventing normal sebum drainage.
          </span>
        </li>
        <li className="flex items-start gap-3">
          <span className="w-[7px] h-[7px] aspect-square rounded-full bg-[#937abd] border-[1.5px] border-black dark:border-white mt-2.5 shrink-0" />
          <span>
            <strong className="text-zinc-950 dark:text-white font-bold">Unbound Free Testosterone Surge:</strong> Lower Sex Hormone-Binding Globulin (SHBG) during the late luteal phase frees more bioactive testosterone to stimulate sebocytes.
          </span>
        </li>
      </ul>
      ...
      <h3 className="text-xl sm:text-2xl font-bold text-zinc-950 dark:text-white pt-4 font-[family-name:var(--font-outfit)]">
        Follicular Phase vs. Luteal Phase Skin Dynamics
      </h3>
      ...
      <div className="overflow-x-auto my-6 border-[3px] border-zinc-950 dark:border-white rounded-2xl bg-white dark:bg-zinc-950 shadow-xs">
        <table className="w-full text-left text-sm">
          <thead className="bg-zinc-100 dark:bg-zinc-900 text-zinc-950 dark:text-white font-bold border-b-2 border-zinc-950 dark:border-white">
            <tr>
              <th className="py-3.5 px-4 font-bold">Cycle Phase</th>
              <th className="py-3.5 px-4 font-bold">Dominant Hormones</th>
              <th className="py-3.5 px-4 font-bold">Follicular &amp; Sebum State</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800 text-zinc-700 dark:text-zinc-300">
            <tr className="hover:bg-zinc-50/50 dark:hover:bg-zinc-900/50 transition-colors">
              <td className="py-3 px-4 font-semibold text-zinc-950 dark:text-white">Follicular Phase (Days 1–14)</td>
              <td className="py-3 px-4">High Estrogen Dominance</td>
              <td className="py-3 px-4">Promotes hyaluronic acid synthesis, keeps pore diameter open, minimizes systemic facial inflammation.</td>
            </tr>
            <tr className="hover:bg-zinc-50/50 dark:hover:bg-zinc-900/50 transition-colors">
              <td className="py-3 px-4 font-semibold text-zinc-950 dark:text-white">Luteal Phase (Days 15–28)</td>
              <td className="py-3 px-4">Progesterone &amp; Androgen Peak</td>
              <td className="py-3 px-4">Constricts pore openings, increases sebum lipid viscosity, triggers painful jawline &amp; chin papules.</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-zinc-950 dark:text-white pt-4 font-[family-name:var(--font-outfit)]">
        Luteal Phase Prevention Protocol
      </h2>

      <ol className="space-y-4 pl-1 my-6 list-decimal list-inside font-medium text-zinc-900 dark:text-zinc-200">
        <li className="leading-relaxed">
          <strong className="text-zinc-950 dark:text-white font-bold">Pre-emptively introduce Salicylic Acid 7 days before period:</strong> Dissolve follicular lipid plugs before progesterone constricts pore diameter.
        </li>
        <li className="leading-relaxed">
          <strong className="text-zinc-950 dark:text-white font-bold">Reduce inflammatory dairy &amp; refined sugars during luteal phase:</strong> Minimize additive IGF-1 signaling when androgen sensitivity is highest.
        </li>
      </ol>
      ...
      <div className="mt-14 sm:mt-20 text-center flex flex-col items-center justify-center gap-6">
        <div className="max-w-2xl mx-auto space-y-3">
          ...
          <p className="text-zinc-600 dark:text-zinc-300 text-base sm:text-lg leading-relaxed font-normal max-w-xl mx-auto">
            Skin Story helps you log monthly timing and observe skin changes.
          </p>
        </div>
