...
export default function Blog9() {
  return (
    <div className="text-zinc-700 dark:text-zinc-300 text-base sm:text-[17px] leading-[1.75] space-y-7">
      <p>
        Washing your face with very hot water in the shower can feel soothing, but high water temperatures can strip natural skin moisture. Very hot water dissolves protective lipids on the outer layer, leading to sudden dryness and temporary flushing. <Link href="/blog/how-long-does-it-take-to-repair-a-damaged-skin-barrier" className="font-semibold text-zinc-950 dark:text-white hover:text-[#937abd] dark:hover:text-[#937abd] transition-colors">How long does it take to repair a damaged skin barrier?</Link> Consistent hot water washing can slow down barrier recovery.
      </p>
      ...
      <div className="p-6 sm:p-7 rounded-2xl sm:rounded-3xl bg-white dark:bg-zinc-950 border-[3px] border-zinc-950 dark:border-white shadow-md my-8">
        ...
        <p className="text-sm sm:text-base font-medium text-zinc-900 dark:text-zinc-100 leading-relaxed">
          Hot water can trigger a rebound response: when surface moisture is stripped quickly, skin may overcompensate by producing extra oil shortly afterward.
        </p>
      </div>

      <p>
        Lukewarm water is ideal for cleansing because it removes daily buildup effectively without disrupting natural hydration.
      </p>
      ...
      <div className="w-full aspect-[16/10] sm:aspect-[16/9] rounded-2xl sm:rounded-3xl overflow-hidden my-10 shadow-sm border border-zinc-200/80 dark:border-zinc-800 bg-zinc-100 dark:bg-zinc-900">
        <img
          src="/blog-hot-water.jpg"
          alt="Illustration of water temperature cleansing"
      ...
      <div className="overflow-x-auto my-6 border-[3px] border-zinc-950 dark:border-white rounded-2xl bg-white dark:bg-zinc-950">
        <table className="w-full text-left text-sm">
          <thead className="bg-zinc-100 dark:bg-zinc-900 text-zinc-950 dark:text-white font-bold border-b-2 border-zinc-950 dark:border-white">
            <tr>
              <th className="py-3.5 px-4 font-bold">Temperature</th>
              <th className="py-3.5 px-4 font-bold">Lipid Layer Impact</th>
              <th className="py-3.5 px-4 font-bold">Typical Outcome</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800">
            <tr>
              <td className="py-3 px-4 font-semibold text-zinc-950 dark:text-white">Hot Water</td>
              <td className="py-3 px-4">Strips surface oils quickly</td>
              <td className="py-3 px-4">Flushing, tightness, and potential rebound oiliness</td>
            </tr>
            <tr>
              <td className="py-3 px-4 font-semibold text-zinc-950 dark:text-white">Lukewarm Water</td>
              <td className="py-3 px-4">Preserves natural hydration</td>
              <td className="py-3 px-4">Comfortable cleansing without tightness</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-zinc-950 dark:text-white pt-4 font-[family-name:var(--font-outfit)]">
        Healthy Cleansing Tips
      </h2>

      <ol className="space-y-4 pl-1 my-6 list-decimal list-inside font-medium text-zinc-900 dark:text-zinc-200">
        <li className="leading-relaxed">
          <strong className="text-zinc-950 dark:text-white font-bold">Wash at the sink with tepid water:</strong> Avoid placing face directly under steaming shower streams.
        </li>
        <li className="leading-relaxed">
          <strong className="text-zinc-950 dark:text-white font-bold">Moisturize after cleansing:</strong> Apply a gentle cream while skin is still slightly damp to hold in moisture.
        </li>
      </ol>
      ...
      <div className="mt-14 sm:mt-20 text-center flex flex-col items-center justify-center gap-6">
        <div className="max-w-2xl mx-auto space-y-3">
          ...
          <p className="text-zinc-600 dark:text-zinc-300 text-base sm:text-lg leading-relaxed font-normal max-w-xl mx-auto">
            Skin Story helps you record daily skincare habits and track your skin's comfort.
          </p>
        </div>
